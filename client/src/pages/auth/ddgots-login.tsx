...
import { AlertCircle, Settings, Cog, User, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-2">DDGOTS Portal</h1>
        ...
        <Card className="bg-white shadow-xl border-slate-200">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 text-center">
              <p className="text-sm text-emerald-700 font-medium">Test Credentials:</p>
              <p className="text-xs text-emerald-600">Username: <code className="bg-emerald-100 px-1 rounded">ddg_operations</code></p>
              <p className="text-xs text-emerald-600">Password: <code className="bg-emerald-100 px-1 rounded">ddgotspassword123</code></p>
            </div>
