    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Agricultural Portal Access</h1>
          <p className="text-slate-600 text-lg">Choose your portal to access AgriTrace360™</p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleFarmerLogin} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="farmer-username" className="text-slate-700">Username</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="farmer-password" className="text-slate-700">Password</Label>
                  <Input
                    id="farmer-password"
                    name="password"
                    type="password"
          ...
          <Card className="bg-white shadow-xl border-slate-200">
            ...
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleBuyerLogin} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="buyer-username" className="text-slate-700">Username</Label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-4 h-4" />
                    <Input
                      id="buyer-username"
                ...
                <div className="space-y-2">
                  <Label htmlFor="buyer-password" className="text-slate-700">Password</Label>
                  <Input
                    id="buyer-password"
                    name="password"
                    type="password"
