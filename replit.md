...
- **MAINTENANCE MODE CONFIGURATION**: Clean server setup with MAINTENANCE_MODE flag controlling page display. Bypasses Vite in maintenance mode and serves direct HTML response with red gradient background, LACRA branding, and professional maintenance messaging.
