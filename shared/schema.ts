...
// ============================================================================
// SELLERS HUB SCHEMA EXPORTS & VALIDATION
// ============================================================================
...
export const insertExporterOfferResponseSchema = createInsertSchema(exporterOfferResponses).omit({
  ...
  transactionId: true,
  respondedAt: true,
  lastNegotiationAt: true,
  finalizedAt: true,
  createdAt: true,
  updatedAt: true,
});

export const insertOfferNegotiationSchema = createInsertSchema(offerNegotiations).omit({
  id: true,
  negotiationId: true,
  isRead: true,
  readAt: true,
...
export const insertBuyerExporterVerificationSchema = createInsertSchema(buyerExporterVerifications).omit({
  id: true,
  verificationId: true,
  verificationCode: true,
...
export type InsertBuyerExporterOffer = z.infer<typeof insertBuyerExporterOfferSchema>;

export type ExporterOfferResponse = typeof exporterOfferResponses.$inferSelect;
export type InsertExporterOfferResponse = z.infer<typeof insertExporterOfferResponseSchema>;

export type OfferNegotiation = typeof offerNegotiations.$inferSelect;
export type InsertOfferNegotiation = z.infer<typeof insertOfferNegotiationSchema>;

export type BuyerExporterVerification = typeof buyerExporterVerifications.$inferSelect;
export type InsertBuyerExporterVerification = z.infer<typeof insertBuyerExporterVerificationSchema>;
