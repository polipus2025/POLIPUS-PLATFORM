  ...
  return (
    <div className="min-h-screen isms-gradient" style={{ overflowY: 'auto', height: 'auto' }}>
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {/* System Administration & Classic Portals */}
        <div className="isms-card mt-8 sm:mt-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold text-slate-900">Independent Access Portals</h3>
              <p className="text-slate-600">Alternative portal access for administrators and regulatory staff</p>
            </div>
          </div>
        ...
        <div id="login-portals" className="isms-card mt-8 sm:mt-12">
          <div className="text-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl isms-icon-bg-blue flex items-center justify-center mx-auto mb-4 sm:mb-6">
                ...
                <div className="isms-card hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-green-300 h-full">
                  <div className="text-center p-4 h-full flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="font-bold text-slate-900 mb-2">Regulatory</h4>
                ...
                <div className="isms-card hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-green-300 h-full">
                  <div className="text-center p-4 h-full flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="font-bold text-slate-900 mb-2">Farmer & Buyer</h4>
                ...
                <div className="isms-card hover:shadow-lg transition-all duration-300 cursor-pointer border-2 hover:border-blue-300 h-full">
                  <div className="text-center p-4 h-full flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="font-bold text-slate-900 mb-2">Inspector</h4>
            ...
            <div className="mt-6 text-xs text-slate-500">
              <p>Secure authentication required for all portals. Contact administrators for access credentials.</p>
            </div>
          </div>
        </div>
      </div>
