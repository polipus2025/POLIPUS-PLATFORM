...
import { Shield, Leaf, Users, ArrowRight, MapPin, BarChart3, FileCheck, Globe, Package, Clock, Calendar, Cloud, Sun, CloudRain, Waves, Anchor, Ship, Fish } from "lucide-react";
...
export default function AquaTracePortal() {
  ...
  return (
    <div className="min-h-screen isms-gradient">
      <Helmet>
        <title>Aqua Trace - Ocean and Marine Monitoring Platform | Ministry of Fisheries</title>
        <meta name="description" content="Advanced marine monitoring and fisheries management system for Liberian coastal and ocean resources" />
      </Helmet>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-8">
              <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div>
                  <h1 className="text-lg sm:text-xl font-bold text-gray-900">Aqua Trace</h1>
                  <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Ministry of Fisheries & Aquaculture</p>
                  <p className="text-xs text-gray-600 sm:hidden">MFA</p>
                </div>
              </div>
              
              {/* Time, Date, and Weather Widget */}
              <div className="hidden lg:flex items-center space-x-6 bg-gradient-to-r from-cyan-50 to-blue-50 px-4 py-2 rounded-lg border border-cyan-100">
                {/* Date and Time */}
              ...
              {/* Mobile compact view */}
              <div className="lg:hidden flex items-center space-x-3 bg-gradient-to-r from-cyan-50 to-blue-50 px-3 py-1 rounded-lg border border-cyan-100">
                <Clock className="h-4 w-4 text-blue-600" />
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-500">Ministry of Fisheries & Aquaculture</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto p-8">
        ...
        <div className="isms-card text-center mb-12">
          <div className="w-20 h-20 rounded-2xl isms-icon-bg-cyan flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-xl text-slate-600 max-w-4xl mx-auto mb-8">
            Advanced marine monitoring and fisheries management system for Liberian coastal and ocean resources 
            with real-time vessel tracking, fish stock monitoring, and comprehensive ocean health analytics.
          </p>
          
          {/* Key Features - ISMS Style */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="isms-card text-center">
              <div className="w-12 h-12 rounded-xl isms-icon-bg-cyan flex items-center justify-center mx-auto mb-3">
                <Ship className="h-6 w-6 text-white" />
              </div>
              <p className="text-slate-600 text-sm mb-1">Vessel</p>
            ...
            <div className="isms-card text-center">
              ...
              <p className="text-slate-600 text-sm mb-1">Fish</p>
              <p className="text-2xl font-bold text-slate-900 mb-2">Stock</p>
            ...
            <div className="isms-card text-center">
              ...
              <p className="text-slate-600 text-sm mb-1">Ocean</p>
        ...
        <div className="isms-card mb-12">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-600">Role-based authentication for marine resource management</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="isms-card group hover:shadow-xl transition-all duration-300 h-80 flex flex-col p-4">
              <div className="text-center pb-3">
                <div className="w-12 h-12 rounded-xl isms-icon-bg-cyan flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                  <Fish className="h-6 w-6 text-white" />
                </div>
              ...
              <div className="space-y-2 mb-4 flex-1">
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  ...
                  <span className="leading-tight">Catch reporting</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                ...
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  ...
                  <span className="leading-tight">Fishing areas</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-slate-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Weather updates</span>
                </div>
              </div>
            ...
            <div className="isms-card group hover:shadow-xl transition-all duration-300 h-80 flex flex-col p-4">
              ...
              <div className="space-y-2 mb-4 flex-1">
                ...
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-cyan-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Species monitoring</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-sky-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Water quality</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
            ...
            <div className="isms-card group hover:shadow-xl transition-all duration-300 h-80 flex flex-col p-4">
              ...
              <div className="space-y-2 mb-4 flex-1">
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-sky-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Patrol operations</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-blue-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Vessel inspections</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-cyan-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Illegal fishing</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-teal-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Emergency response</span>
                </div>
              </div>
            ...
            <div className="isms-card group hover:shadow-xl transition-all duration-300 h-80 flex flex-col p-4">
              ...
              <div className="space-y-2 mb-4 flex-1">
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-cyan-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Port management</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-blue-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Vessel registration</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-sky-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Harbor operations</span>
                </div>
                <div className="flex items-start gap-2 text-xs text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-teal-500 mt-1 flex-shrink-0"></div>
                  <span className="leading-tight">Safety oversight</span>
                </div>
              </div>
        ...
        <div className="isms-card mb-12">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl isms-icon-bg-cyan flex items-center justify-center">
              <BarChart3 className="h-6 w-6 text-white" />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-slate-900">Platform Statistics</h3>
              <p className="text-slate-600">Comprehensive marine resource monitoring coverage</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="isms-card text-center">
              ...
              <p className="text-slate-600 text-sm mb-1">Coastal</p>
            ...
            <div className="isms-card text-center">
              ...
              <p className="text-slate-600 text-sm mb-1">Fishing</p>
              <p className="text-3xl font-bold text-slate-900 mb-2">1,200+</p>
              <p className="text-slate-600 text-sm">Vessels</p>
            </div>
        ...
        <div className="isms-card text-center">
          ...
          <p className="text-slate-600 mb-6">
            Contact your local fisheries office or system administrator for account setup and technical support.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div className="bg-slate-50 rounded-lg p-4">
              <p className="text-sm font-medium text-slate-900">Marine Hotline</p>
              <p className="text-slate-600">+231 77 OCEAN-1</p>
            </div>
            <div className="bg-slate-50 rounded-lg p-4">
              <p className="text-sm font-medium text-slate-900">Email Support</p>
              <p className="text-slate-600">support@mfa.gov.lr</p>
            </div>
            <div className="bg-slate-50 rounded-lg p-4">
              <p className="text-sm font-medium text-slate-900">Emergency</p>
              <p className="text-slate-600">+231 88 OCEAN-911</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="isms-card mt-12">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-2 font-medium">
            © 2025 Ministry of Fisheries & Aquaculture
          </p>
          <p className="text-sm text-slate-500">
            Aqua Trace - Securing Liberia's Marine Future
          </p>
        </div>
      </footer>
    </div>
