        ...
        <div className="isms-card mb-8">
          <div className="text-center py-12">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto">
              The Live Trace portal is currently under development. This comprehensive livestock 
              monitoring system will provide real-time tracking, health monitoring, and movement 
              control capabilities for agricultural communities.
            </p>
