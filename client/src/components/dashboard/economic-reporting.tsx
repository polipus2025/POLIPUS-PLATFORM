  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center">
                <div className="w-4 h-4 rounded isms-icon-bg-green flex items-center justify-center mr-1">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">GDP Contribution</p>
        ...
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">Employment</p>
              <p className="text-xl font-bold text-slate-900 text-center">
                {(economicOverview.totalEmployment / 1000).toFixed(1)}K
              </p>
              <p className="text-xs text-slate-500 mt-1 text-center truncate">Total jobs</p>
            </div>
          </div>
        </div>
        ...
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">Active Businesses</p>
              <p className="text-xl font-bold text-slate-900 text-center">
                {(economicOverview.activeBusinesses / 1000).toFixed(1)}K
              </p>
              <p className="text-xs text-slate-500 mt-1 text-center truncate">Registered</p>
            </div>
          </div>
        </div>
        ...
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">Tax Revenue</p>
              <p className="text-xl font-bold text-slate-900 text-center">
                ${(economicOverview.totalTaxRevenue / 1000000).toFixed(1)}M
              </p>
              <p className="text-xs text-slate-500 mt-1 text-center truncate">Monthly</p>
            </div>
          </div>
        </div>
        ...
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">Export Value</p>
              <p className="text-xl font-bold text-slate-900 text-center">
        ...
        <div className="isms-card h-32 p-3">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xs font-medium text-slate-600 mb-1 truncate">Top Commodities</p>
              <p className="text-sm font-bold text-slate-900 leading-tight text-center">
                Cocoa, Coffee
              </p>
              <p className="text-xs text-slate-500 mt-1 text-center truncate">Leading exports</p>
            </div>
          </div>
        </div>
      </div>
