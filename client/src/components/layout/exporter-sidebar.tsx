...
const ExporterSidebar = memo(({ user }: ExporterSidebarProps) => {
  ...
  const sidebarItems = [
    ...
    { 
      href: '/exporter-payment-services', 
      label: 'Payments', 
      icon: CreditCard,
...
ExporterSidebar.displayName = 'ExporterSidebar';
